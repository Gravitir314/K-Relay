namespace K_Relay
{
    partial class FrmMainMetro
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnAddAccount = new System.Windows.Forms.ToolStripMenuItem();
			this.btnDelAccount = new System.Windows.Forms.ToolStripMenuItem();
			this.btnSelectAccount = new System.Windows.Forms.ToolStripMenuItem();
			this.btnClearAccount = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.tabAccounts = new MetroFramework.Controls.MetroTabPage();
			this.menuAccounts = new System.Windows.Forms.MenuStrip();
			this.tbxAccountInfo = new K_Relay.Controls.MetroRichTextBox();
			this.listAccounts = new K_Relay.Controls.MetroListBox();
			...
			this.menuAccounts.SuspendLayout();
        ...
        "Select a Plugin to view its description."};
			...
			// tabAccounts
			//
			this.tabAccounts.Controls.Add(this.menuAccounts);
			this.tabAccounts.Controls.Add(this.tbxAccountInfo);
			this.tabAccounts.Controls.Add(this.listAccounts);
			this.tabAccounts.HorizontalScrollbarBarColor = false;
			this.tabAccounts.HorizontalScrollbarHighlightOnWheel = false;
			this.tabAccounts.HorizontalScrollbarSize = 0;
			this.tabAccounts.Location = new System.Drawing.Point(4, 38);
			this.tabAccounts.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.tabAccounts.Name = "tabAccounts";
			this.tabAccounts.Size = new System.Drawing.Size(826, 429);
			this.tabAccounts.TabIndex = 0;
			this.tabAccounts.Text = "Accounts";
			this.tabAccounts.VerticalScrollbarBarColor = false;
			this.tabAccounts.VerticalScrollbarHighlightOnWheel = false;
			this.tabAccounts.VerticalScrollbarSize = 0;
			// 
			// btnAddAccount
			// 
			this.btnAddAccount.Name = "btnAddAccount";
			this.btnAddAccount.Size = new System.Drawing.Size(96, 45);
			...
			this.btnDelAccount.Size = new System.Drawing.Size(96, 45);
			...
			this.btnSelectAccount.Size = new System.Drawing.Size(96, 45);
			this.btnSelectAccount.Text = "Select";
			this.btnSelectAccount.Click += new System.EventHandler(this.btnSelectAccount_Click);
			// 
			// btnClearAccount
			// 
			this.btnClearAccount.Name = "btnClearAccount";
			this.btnClearAccount.Size = new System.Drawing.Size(96, 45);
			this.btnClearAccount.Text = "Clear";
			this.btnClearAccount.Click += new System.EventHandler(this.btnClearAccount_Click);
			//
			// menuAccounts
			//
			this.menuAccounts.AutoSize = false;
			this.menuAccounts.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(231)))), ((int)(((byte)(113)))), ((int)(((byte)(189)))));
			this.menuAccounts.ImageScalingSize = new System.Drawing.Size(24, 24);
            this.menuAccounts.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.btnAddAccount,
			this.btnDelAccount,
			this.btnSelectAccount,
			this.btnClearAccount});
			this.menuAccounts.Location = new System.Drawing.Point(300, 0);
			this.menuAccounts.Name = "menuAccounts";
			this.menuAccounts.Padding = new System.Windows.Forms.Padding(9, 3, 0, 3);
			this.menuAccounts.Size = new System.Drawing.Size(526, 51);
			this.menuAccounts.TabIndex = 0;
			this.menuAccounts.Text = "menuStrip1";
			// 
			// tbxAccountInfo
			// 
			this.tbxAccountInfo.BackColor = System.Drawing.SystemColors.Control;
			this.tbxAccountInfo.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.tbxAccountInfo.Font = new System.Drawing.Font("Segoe UI", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.tbxAccountInfo.Lines = new string[] {
		"Select a Account to view its description."};
			this.tbxAccountInfo.Location = new System.Drawing.Point(298, 51);
			this.tbxAccountInfo.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.tbxAccountInfo.MaxLength = 2147483647;
			this.tbxAccountInfo.Multiline = true;
			this.tbxAccountInfo.Name = "tbxAccountInfo";
			this.tbxAccountInfo.ScrollBars = System.Windows.Forms.RichTextBoxScrollBars.Both;
			this.tbxAccountInfo.SelectedText = "";
			this.tbxAccountInfo.Size = new System.Drawing.Size(524, 355);
			this.tbxAccountInfo.TabIndex = 0;
			this.tbxAccountInfo.Text = "Select a Account to view its description.";
			this.tbxAccountInfo.UseSelectable = true;
			this.tbxAccountInfo.UseStyleColors = true;
			// 
			// listAccounts
			// 
			this.listAccounts.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.listAccounts.Dock = System.Windows.Forms.DockStyle.Left;
			this.listAccounts.Font = new System.Drawing.Font("Segoe UI", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.listAccounts.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.listAccounts.Name = "listAccounts";
			this.listAccounts.Size = new System.Drawing.Size(300, 429);
			this.listAccounts.TabIndex = 0;
			this.listAccounts.TabStop = false;
			this.listAccounts.UseSelectable = true;
			this.listAccounts.UseStyleColors = true;
        ...
        "Select a Packet to view its description."};
			...
			this.menuAccounts.ResumeLayout(false);
			this.menuAccounts.PerformLayout();
		...
		private MetroFramework.Controls.MetroTabPage tabAccounts;
		...
		private System.Windows.Forms.ToolStripMenuItem btnAddAccount;
		private System.Windows.Forms.ToolStripMenuItem btnDelAccount;
		private System.Windows.Forms.ToolStripMenuItem btnSelectAccount;
		private System.Windows.Forms.ToolStripMenuItem btnClearAccount;
		private MetroFramework.Controls.MetroLabel lblStatus;
		private K_Relay.Controls.MetroListBox listPlugins;
		private K_Relay.Controls.MetroListBox listAccounts;
		private K_Relay.Controls.MetroListBox listPackets;
        private System.Windows.Forms.MenuStrip menuPlugins;
		private System.Windows.Forms.MenuStrip menuAccounts;
		...
		private K_Relay.Controls.MetroRichTextBox tbxAccountInfo;
